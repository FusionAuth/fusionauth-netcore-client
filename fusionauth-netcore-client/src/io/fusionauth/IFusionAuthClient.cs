...
namespace io.fusionauth {
  public interface IFusionAuthAsyncClient {
    ...
    /// </summary>
    /// <param name="changePasswordId"> The change password Id used to find the user. This value is generated by FusionAuth once the change password workflow has been initiated.</param>
    /// <param name="ipAddress"> (Optional) IP address of the user changing their password. This is used for MFA risk assessment.</param>
    /// <returns>
    /// When successful, the response will contain the log of the action. If there was a validation error or any
    /// other type of error, this will return the Errors object in the response. Additionally, if FusionAuth could not be
    /// contacted because it is down or experiencing a failure, the response will contain an Exception, which could be an
    /// IOException.
    /// </returns>
    Task<ClientResponse<RESTVoid>> CheckChangePasswordUsingIdAndIPAddressAsync(string changePasswordId, string ipAddress);
    ...
    /// IOException.
    /// </returns>
    Task<ClientResponse<TwoFactorStatusResponse>> RetrieveTwoFactorStatusWithRequestAsync(TwoFactorStatusRequest request);
 ...
 public interface IFusionAuthSyncClient {
   ...
   /// IOException.
   /// </returns>
   ClientResponse<RESTVoid> CheckChangePasswordUsingIdAndIPAddress(string changePasswordId, string ipAddress);
   ...
   /// IOException.
   /// </returns>
   ClientResponse<TwoFactorStatusResponse> RetrieveTwoFactorStatusWithRequest(TwoFactorStatusRequest request);
